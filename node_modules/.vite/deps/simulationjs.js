...
// node_modules/.pnpm/simulationjs@3.7.9/node_modules/simulationjs/dist/simulation.js
...
var SimulationElement = class {
  ...
  moveTo(p, t = 0, f) {
    ...
    return transitionValues(() => {
      ...
      this.pos.x += changeX * p2;
      this.pos.y += changeY * p2;
      return this.running;
    }, () => {
      this.pos.x = p.x;
      this.pos.y = p.y;
...
var Color = class {
  ...
  toHex() {
    return "#" + this.compToHex(this.r) + this.compToHex(this.g) + this.compToHex(this.b) + this.compToHex(this.a * 255);
  }
};
var SceneCollection = class extends SimulationElement {
  constructor(name = "") {
    ...
    __publicField(this, "_isSceneCollection", true);
    __publicField(this, "camera");
    __publicField(this, "displaySurface");
    __publicField(this, "ratio");
    __publicField(this, "lightSources");
    __publicField(this, "ambientLighting");
    __publicField(this, "planesSortFunc");
    this.name = name;
    this.scene = [];
...
var Line = class extends SimulationElement {
  ...
  setStart(p, t = 0, f) {
    ...
    return transitionValues(() => {
      ...
      this.startPoint.x += xChange * p2;
      this.startPoint.y += yChange * p2;
      return this.running;
    }, () => {
      this.startPoint = p;
    }, t, f);
  ...
  setEnd(p, t = 0, f) {
    ...
    return transitionValues(() => {
      ...
      this.endPoint.x += xChange * p2;
      this.endPoint.y += yChange * p2;
      return this.running;
    }, () => {
      this.endPoint = p;
    }, t, f);
...
var Circle = class extends SimulationElement {
  constructor(pos, radius, color = new Color(0, 0, 0), startAngle = 0, endAngle = 360, thickness = 1, rotation = 0, fill = true, counterClockwise = false) {
    ...
    __publicField(this, "counterClockwise");
    __publicField(this, "thickness");
    __publicField(this, "rotation");
    __publicField(this, "fillCircle");
    this.radius = radius;
...
var Polygon = class extends SimulationElement {
  ...
  setPoints(points, t = 0, f) {
    ...
    const changes = [
      ...
      ...this.points.slice(points.length, this.points.length).map((point) => (points[points.length - 1] || new Vector(0, 0)).clone().sub(point))
    ];
    return transitionValues(() => {
      ...
      this.points = this.points.map((point, i) => {
        var _a, _b;
        point.x += (((_a = changes[i]) == null ? void 0 : _a.x) || 0) * p;
        point.y += (((_b = changes[i]) == null ? void 0 : _b.y) || 0) * p;
        return point;
      });
      return this.running;
    }, () => {
...
var Plane = class extends SimulationElement3d {
  ...
  setPoints(points, t = 0, f) {
    ...
    const changes = [
      ...points.map((p, i) => p.clone().sub(this.points[i])),
      ...this.points.slice(points.length, this.points.length).map((point) => (points[points.length - 1] || new Vector3(0, 0, 0)).clone().sub(point))
    ];
    return transitionValues(() => {
      ...
      this.points = this.points.map((point, i) => {
        ...
        point.x += (((_a = changes[i]) == null ? void 0 : _a.x) || 0) * p;
        point.y += (((_b = changes[i]) == null ? void 0 : _b.y) || 0) * p;
        point.z += (((_c = changes[i]) == null ? void 0 : _c.z) || 0) * p;
        return point;
      });
      return this.running;
    }, () => {
...
var Cube = class extends SimulationElement3d {
...
var Line3d = class extends SimulationElement3d {
...
var Simulation = class {
  constructor(el, cameraPos = new Vector3(0, 0, -200), cameraRot = new Vector3(0, 0, 0), displaySurfaceDepth, center = new Vector(0, 0), displaySurfaceSize) {
    ...
    __publicField(this, "ratio");
    __publicField(this, "running");
    __publicField(this, "_prevReq");
    __publicField(this, "events");
    __publicField(this, "ctx", null);
    __publicField(this, "camera");
    __publicField(this, "center");
    __publicField(this, "displaySurface");
    __publicField(this, "forward", new Vector3(0, 0, 1));
    __publicField(this, "backward", new Vector3(0, 0, -1));
    __publicField(this, "left", new Vector3(-1, 0, 0));
    __publicField(this, "right", new Vector3(1, 0, 0));
    __publicField(this, "up", new Vector3(0, -1, 0));
...
function transitionValues(callback1, callback2, callback3, transitionLength, func) {
...
function projectPoint(p, cam, displaySurface) {
  const mat1 = [
    [1, 0, 0],
